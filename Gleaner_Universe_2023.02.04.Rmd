...
g_u <- g_u %>%
      mutate(Playback = replace(Species_full, Species_full == "Lampronycteris brachiotis", "Lampronycteris brachyotis" )) %>%
      mutate(Playback = replace(Species_full, Species_full == "Lonchorina aurita", "Lonchorhina aurita"))
...
facet_plot_bats <- function(d=d, ranked= FALSE, Boots = FALSE, N_min_mean = NULL, N_min_int = NULL, Width = 177, Height =800, title = c("all_bats_", "over_10n_", "")){

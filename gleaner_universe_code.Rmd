...
```{r}
g_u <- read_excel("~/Dropbox/gleaner_universe_compiled_r.xlsx", 
...
```{r}
#theme: 
TM <- theme_calc(base_size = 25) + theme(axis.text.x = element_text(angle = 45, hjust=1, size = 14))
...
g_u$Playback<- factor(g_u$Playback, levels = c( "Acla"       ,     "Aclodes"   ,  "Anaxipha", "A. spatulata" , "B. maculipennis", "V. zedersted"  ,  "C. wheeleri" ,  "D. gigliotosi"  , "Q. gigas" ,  "Z. smaragdina"   ,  
        "E. diastema" , "H. fleishmanni", "D. ebraccatus" ,  "S. sila"     ,      "P. pustulosus" ,  "H. frenatus" , "T. rapicauda"  , 
    "Beetle flight",  "frog hopping"  , "mouse rustles", "White_noise"), ordered = TRUE )
```
...
#ggsave("gleaner_universe_full.jpg", width = 17)
...
g_u_p_avg 
 ...
 #ggsave("gleaner_universe_avg.jpg",  width = 17) 
